...
export default function SkillCategory({
  ...
  return (
    <div className="h-full rounded-2xl border border-white/10 bg-white/3 p-6 backdrop-blur-sm transition-colors duration-300 hover:border-white/20 hover:bg-white/5">
